...
if (!kBlock && kAction) {
    if (!attacking) {
        ...
        // Jab in place
            ...
            image_index  = 0;
            image_speed  = 0.33;
            sprite_index = sBoredJab;
            
			with (instance_create(x+(facing*130), y, oEnemyAttack)) { facing=other.facing; boredom_damage=10;
			}
...
// Jab
if (sprite_index == sBoredJab && round(image_index) > 0) {    
    with (instance_create(x, y, oPlayerAtkBox)) {
