...
if (!kBlock && kAction) {
    if (!attacking) {
        ...
        // Jab in place
            ...
            image_index  = 0;
            image_speed  = 0.33;
            sprite_index = sFilthJab;
            
			with (instance_create(x+(facing*170), y, oEnemyAttack)) { facing=other.facing; filth_damage=10;
			}
...
// Jab
if (sprite_index == sFilthJab && round(image_index) > 0) {    
    with (instance_create(x, y, oPlayerAtkBox)) {
